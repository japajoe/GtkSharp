...
namespace GtkSharp.Gdk.Native
{
    internal static class NativeGdkCairo
    {
        ...
        [DllImport(NATIVELIB_GDKCAIRO, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void gdk_cairo_set_source_pixbuf(CairoPointer cr, GObjectPointer pixbuf, double pixbuf_x, double pixbuf_y);
        ...
        [DllImport(NATIVELIB_GDKCAIRO, CallingConvention = CallingConvention.Cdecl)]
        internal static extern CairoRegionPointer gdk_cairo_surface_create_from_pixbuf(GObjectPointer pixbuf, int scale, GdkWindowPointer for_window);
